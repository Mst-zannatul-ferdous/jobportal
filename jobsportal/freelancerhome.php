    ...
    <div class="w3-container w3-cell w3-border w3-round-xlarge" style="width: 25%;padding: 2%;">
      ...
      ?>
        ...
        <div class="w3-card-4 w3-border w3-round-xlarge" style="padding: 0px;">
          <a href="freelancerupdate.php" class="w3-button w3-red w3-round-xlarge" style="width: 100%;">Edit</a>
        </div>
   ...
   ?>
    ...
    <div class="w3-container w3-cell w3-border w3-round-xlarge" style="width: 25%;padding: 2%">
      ...
      <div class="w3-card-4 w3-border w3-round-xlarge" style="padding: 2%">
        ...
        <p>Choose your suitable job from the list. Customize the list as you like by clicking the buttons. Use
          <b>Recommended</b> to sort job according your skills and use <b>Sort</b> button to sort the job according to
          price of the job. </p>
