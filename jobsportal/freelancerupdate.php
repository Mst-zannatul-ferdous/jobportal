...
<body bgcolor="#E6E6FA">
  ...
  <?php include 'freelancer-header.php'; ?>
  <!---------------------body starts from here------------------------------------->


  <div>
    <form class="w3-container" method="post"
      style="padding-left: 20%;padding-right: 20%;background-color: transparent;padding-top: 5%;">

      <p>
        <label>Name</label>
        <input class="w3-input w3-hover-teal" type="text" name="name" style="background-color: rgb(255, 255, 255,0.5)"
          value="<?php echo $req42['name'];?>">
      </p>
      ...
      <p>
        <label>Email</label>
        <input class="w3-input w3-hover-teal w3-border" type="email" name="email"
          style="background-color: rgb(255, 255, 255,0.5)" value="<?php echo $req42['email'];?>">
      </p>


      <p>
        <label>Phone</label>
        <input class="w3-input w3-hover-teal" type="text" name="phone" style="background-color: rgb(255, 255, 255,0.5)"
          value="<?php echo $req42['phone'];?>">
      </p>
      <p>
        <label>Hourley price
        </label>
        <input class="w3-input w3-hover-teal w3-border" type="number" name="hprice"
          style="background-color: rgb(255, 255, 255,0.5)" value="<?php echo $req42['hprice'];?>">
      </p>
      <p>
        <label>Address</label>
        <input class="w3-input w3-hover-teal" type="text" name="address"
          style="background-color: rgb(255, 255, 255,0.5)" value="<?php echo $req42['address'];?>">
      </p>
      ...
      <input type="submit" name="submit" value="Submit"
        class="w3-input w3-teal w3-round-xxlarge w3-animate-input w3-hover-blue">
    </form>
  </div>
