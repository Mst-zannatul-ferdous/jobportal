  ...
  <div class="w3-row w3-dark-gray">
    ...
    <div class="w3-col s2" style="padding-top: 2%;background-color: transparent;">
      <div class="w3-dropdown-hover" style="background-color: transparent;">
        ...
        <a href="jobapplied.php" class="w3-button w3-round w3-light-blue w3-large">Job Application<span
            class="w3-badge w3-red"><?php echo"$number";?></span></a>
      </div>
    </div>
    <div class="w3-col s2" style="padding-top: 2%;">

      <a href="" class="w3-button w3-round w3-light-blue w3-large">Submisssion<span
          class="w3-badge w3-red"><?php echo"$submission";?></span></a>
    </div>
    <div class="w3-col s2" style="padding-top: 2%;">
      <div class="w3-dropdown-hover" style="background-color: transparent;">
