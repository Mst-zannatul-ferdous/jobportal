...
<body bgcolor="#E6E6FA">
  ...
  <div style="padding-left: 15%;padding-right: 5%;width: 60%;">
    ...
    <div class="w3-card" style="padding: 3%;">
      ...
      <a href="applicantdetails.php?test=<?php echo $arra['postid']; ?>&appl=<?php echo $arra['applicant']; ?>"
        class="w3-button w3-red">Profile</a>

      <a href="applied.php?test=<?php echo $arra['postid']; ?>&appl=<?php echo $arra['applicant']; ?>"
        class="w3-button w3-red">Accept</a>
    </div>
    <br>
    <br>
